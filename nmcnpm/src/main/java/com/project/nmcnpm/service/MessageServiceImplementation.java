...
public class MessageServiceImplementation implements MessageService {
    ...
    public List<MessageResponseDTO> getMessagesByConversationId(Integer conversationId) {
        ...
        List<Message> messages = messageRepository.findByConversationConversationIdOrderByMessageTimeAscWithConversationAndSender(conversationId);
    ...
    public List<MessageResponseDTO> getMessagesBySenderId(Integer senderId) {
        ...
        List<Message> messages = messageRepository.findBySenderUserIdWithConversationAndSender(senderId);
        return messages.stream()
                .map(MessageResponseDTO::new)
                .collect(Collectors.toList());
    }
